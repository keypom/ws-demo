...
const LedgerDerivationPath = ({
  ...
  const [ledgerDerivationPath, setLedgerDerivationPath] = useState(DEFAULT_DERIVATION_PATH);
  ...
  return jsxs("div", Object.assign({
    ...
    children: [jsx("p", {
      ...
      }, void 0), ledgerError && jsx("p", Object.assign({
        className: "error"
      }, {
...
const Modal = ({
  ...
  const [routeName, setRouteName] = useState("WalletOptions");
  ...
  return jsxs("div", Object.assign({
    ...
    children: [jsx("style", {
      ...
      children: jsxs("div", Object.assign({
        ...
        }), void 0), routeName === "AlertMessage" && alertMessage && jsx(AlertMessage, {
          message: alertMessage,
          onBack: () => {
            setAlertMessage(null);
            setRouteName("WalletOptions");
          }
        }, void 0), routeName === "WalletOptions" && jsx(WalletOptions, {
          selector: selector,
          options: options,
          onConnectHardwareWallet: () => {
        ...
        }, void 0), routeName === "LedgerDerivationPath" && jsx(LedgerDerivationPath, {
          selector: selector,
          onConnected: handleDismissClick,
          onBack: () => setRouteName("WalletOptions")
        }, void 0), routeName === "WalletNetworkChanged" && jsx(WalletNetworkChanged, {
          selector: selector,
...
export { setupWalletSelector, transformActions, waitFor };
